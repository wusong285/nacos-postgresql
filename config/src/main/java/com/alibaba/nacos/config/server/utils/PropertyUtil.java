...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private void loadSetting() {
        try {
            ...
            //数据库适配wusong
            String platfrom = getString(PropertiesConstant.SPRING_DATASOURCE_PLATFORM, "");
            setUseExternalDB(PropertiesConstant.MYSQL.equalsIgnoreCase(platfrom) || PropertiesConstant.POSTGRES.equalsIgnoreCase(platfrom));
